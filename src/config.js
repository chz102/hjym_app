...
const headerOptions = props => {
  ...
  return {
    ...
    headerRight,
    header,
    headerTitleStyle: { fontSize: 18, alignSelf: "center", color: "#fff" },
    // headerStyle: {
    //   height: 64,
...
const TabNavigatorConfig = options => {
  ...
  return {
    ...
    tabBarOptions: {
      ...
      style: {
        margin: 0,
        padding: Resolution.isIphoneX()?34:0,
        height: Resolution.isIphoneX()?90:50,
