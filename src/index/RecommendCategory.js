        ...
        return (
            <View style={{backgroundColor:'#F6F6F6'}}>
                <View style={styles.wrapper}>
                    ...
                    <TouchableHighlight underlayColor='#fff' style={{alignItems:'center'}} onPress={()=>this.gotoPage('Category','分类')}>
                    <View style={{alignItems:'center'}}>
                ...
                <View style={{flexDirection:'row',marginTop:10}}>
                    <TouchableHighlight underlayColor='#fff' style={{alignItems:'center'}} onPress={()=>this.gotoPage('ProjectList','热门预约')}>
                    <Image style={{width:351,height:255}} source={{uri:domain+'images/hot_reservation.jpg'}}/>
                    </TouchableHighlight>
                    <View style={{marginLeft:3}}>
                        <TouchableHighlight underlayColor='#fff' style={{alignItems:'center'}} onPress={()=>this.gotoPage('ProjectList','优惠券中心')}>
                        <Image style={{width:400,height:126}} source={{uri:domain+'images/coupon_center.jpg'}}/>
                        </TouchableHighlight>
                        <TouchableHighlight underlayColor='#fff' style={{alignItems:'center'}} onPress={()=>this.gotoPage('BaikeList','整形百科')}>
