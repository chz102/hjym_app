            ...
            <View style={{flex:1,backgroundColor:'#fff'}}>
                <View style={styles.sortBar}>
                    <View style={styles.sortItem}>
                        ...
                        <Image style={{height:28,width:18}} source={require('../../../../images/sort_asc.png')}/>
                    </View>
                    <View style={styles.sortItem}>
                        <Text style={styles.sortText}>预约量</Text>
                        <Image style={{height:28,width:18}} source={require('../../../../images/sort_desc.png')}/></View>
                    <View style={styles.sortItem}>
                        <Text style={styles.sortText}>积分</Text>
                        <Image style={{height:28,width:18}} source={require('../../../../images/sort_desc.png')}/></View>
                    <View>
                        <Image style={{height:38,width:38}} source={require('../../../../images/filter.png')}/>
                    </View>
                </View>
